...
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/running.sh"
...
wget -q -O /usr/bin/menu-bot "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-bot.sh"
wget -q -O /usr/bin/stopbot "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/stopbot.sh"
wget -q -O /usr/bin/menu-theme "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/Themes/thema.sh"

# //
wget -q -O /usr/bin/about "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/about.sh"
...
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-ss.sh"
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-vmess.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-trojan.sh"
#wget -q -O /usr/bin/menu-trgo "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-trgo.sh"
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-ssh.sh"
...
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/usernew.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu.sh"
...
#wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/xp.sh"
wget -q -O /usr/bin/addhost  "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/addhost.sh"
wget -q -O /usr/bin/genssl  "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/genssl.sh"
...
wget -q -O /usr/bin/menu-ipsec "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/ipsec/menu-ipsec.sh"
...
wget -q -O /usr/bin/trial-trojan "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/trial/trial-trojan.sh" && chmod +x /usr/bin/trial-trojan
wget -q -O /usr/bin/trial-udp "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/trial/trial-udp.sh" && chmod +x /usr/bin/trial-udp
wget -q -O /usr/bin/trial-vless "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/trial/trial-vless.sh" && chmod +x /usr/bin/trial-vless
wget -q -O /usr/bin/menu-trial "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/trial/trial-generator.sh" && chmod +x /usr/bin/menu-trial
wget https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/3d.flf
...
wget -q -O /usr/bin/addudp "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/addssh.sh"
wget -q -O /usr/bin/menu-udp "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-udp.sh"

sudo apt install squid -y
mkdir /var/lib/ssnvpn-pro/
rm -f /usr/bin/menu-ssh
wget -q -O /var/lib/ssnvpn-pro/ipvps.conf "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/ipvps.conf"
wget -q -O /usr/bin/autokill "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/autokill.sh"
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/menu-ssh.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/restart.sh"
chmod +x /usr/bin/restart
wget -q -O /usr/bin/bot "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/Finaleuy/bot.sh"
wget -q -O /root/chat "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/Finaleuy/chatid.sh"

wget -q -O /usr/bin/limitvmess "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/limitvmess.sh" && chmod +x /usr/bin/limitvmess

wget -q -O /usr/bin/limitvless "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/limitvless.sh" && chmod +x /usr/bin/limitvless

wget -q -O /usr/bin/limittrojan "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/limittrojan.sh" && chmod +x /usr/bin/limittrojan
wget -q -O /usr/bin/sistem "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/sistem.sh" && chmod +x /usr/bin/sistem
wget -q -O /etc/crontab "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/crontab" && chmod 644 /etc/crontab

wget -q -O /usr/bin/cftn "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/cftn.sh" && chmod +x /usr/bin/cftn

wget -q -O /usr/bin/infosc "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/info.sh" && chmod +x /usr/bin/infosc
echo "*/2 * * * * root sistem" >> /etc/crontab

rm /etc/rsyslog.d/50-default.conf

wget https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/50-default.conf


cp 50-default.conf /etc/rsyslog.d/50-default.conf
service rsyslog restart

wget -q -O /etc/default/dropbear "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/dropbear" && chmod +x /etc/default/dropbear


wget -q -O /usr/bin/xp "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/xp.sh" && chmod +x /usr/bin/xp
...
wget -q -O /usr/bin/limitipxray "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/limit/limitipxray.py" && chmod +x /usr/bin/limitipxray
...
wget https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
wget -q -O /usr/bin/service-trial "https://raw.githubusercontent.com/tanilink/stunnelvpn/momok/menu/service-trial.sh" && chmod +x /usr/bin/service-trial
